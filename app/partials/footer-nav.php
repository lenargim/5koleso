<div class="footer">
  <div class="footer__nav">
    ...
    <div class="footer__col">
      ...
      <nav class="footer__list">
        <li><a href="#" class="footer__link">Калькулятор стоимости</a></li>
    ...
    <div class="footer__col">
      ...
      <div class="footer__mail">
        ...
        <div>Не переживайте, мы присылаем только действительно важные новости</div>
      </div>
    </div>
  </div>
  <div class="footer__bottom">
    ...
    <div class="footer__copy">
      <span>Федеральная сеть «5 колесо» 2010 — 2020. Все права защищены. <a href="mailto:r.biktagirov@5krf.ru">r.biktagirov@5krf.ru</a></span>
      <span>Информация, представленная на сайте, не является публичной офертой. Подробности акций и специальных предложений уточняйте у менеджеров</span>
    </div>
  </div>
</div>