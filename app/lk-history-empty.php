      ...
      <div class="lk__grid">
        ...
        <div class="lk__content">
          ...
          <div class="lk__page history">
            ...
            <div class="history__empty lk__empty">
              <svg>
                <use xlink:href="img/sprite-lk.svg#history-empty"></use>
              </svg>
              <div>Хорошо когда ничего не ломается,<br>но если что вы знаете к кому обратиться</div>
            </div>
          </div>
