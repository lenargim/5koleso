      ...
      <div class="lk__grid">
        ...
        <div class="lk__content">
          ...
          <div class="lk__page car">
            ...
            <div class="car__empty lk__empty">
              <svg>
                <use xlink:href="img/sprite-lk.svg#car-empty"></use>
              </svg>
              <div>Внесите данные о машине, что бы было проще<br>отслеживать данные о последних обращениях</div>
            </div>
